...
public class ClientTrack implements Collides, JSONable {
    ...
    public ClientTrack(Direction startDir, List<TrackTile> tiles) {
        this(startDir, convert(tiles));
    }

    public ClientTrack(Direction startDir, TrackTile... tiles) {
